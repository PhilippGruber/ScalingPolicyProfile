...
public class ProfilesLibrary {
    ...
    //new addition
    public static boolean hasAppliedStereotype(final EObject pcmObject, final String stereotypeName) {
        return StereotypeAPI.isStereotypeApplied(pcmObject, stereotypeName);
    }
